...
set :application, "RhoMobi"
set :repository,  "git://github.com/buyhome/rhomobi.com.git"
set :branch, "master"
set :scm, :git
set :user, "www"
...
role :web, "rhomobi.com"                          # Your HTTP server, Apache/etc
role :app, "rhomobi.com"                          # This may be the same as your `Web` server
role :db,  "rhomobi.com", :primary => true     # This is where Rails migrations will run
